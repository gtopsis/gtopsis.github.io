...
import { ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderClass, ssrRenderList, ssrRenderAttr } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/vue/server-renderer/index.mjs';
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p class="text-center ma-0" data-v-df6e029b${_scopeId3}>${ssrInterpolate(personalMessage)}</p><p class="text-center ma-0" data-v-df6e029b${_scopeId3}>\xA9 ${ssrInterpolate(unref(footerText))}</p>`);
                      } else {
                        return [
...
//# sourceMappingURL=default-76ad7922.mjs.map
