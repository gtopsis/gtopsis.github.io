import { _ as __nuxt_component_0 } from './nuxt-link-343a4f5f.mjs';
import { useSSRContext, defineComponent, resolveComponent, withCtx, createTextVNode, createVNode, toDisplayString, renderSlot, computed, mergeProps, unref, openBlock, createBlock, Fragment, renderList } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/vue/index.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_col, { class: "px-2 py-1" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_tooltip, { location: "bottom end" }, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span data-v-fc0522a4${_scopeId3}>Enable ${ssrInterpolate(unref(disabledTheme))} mode</span>`);
                      } else {
                        return [
                  ...
                  return [
                    createVNode(_component_v_tooltip, { location: "bottom end" }, {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-fc0522a4"]]);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                              ...
                              ssrRenderList(socials, (social, index) => {
                                _push5(ssrRenderComponent(_component_v_col, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<a${ssrRenderAttr("href", social.link)} class="social-link text-secondary" target="_blank" rel="noopener noreferrer" data-v-aa921a51${_scopeId5}>`);
                  ...
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p class="text-center ma-0" data-v-aa921a51${_scopeId3}>${ssrInterpolate(personalMessage)}</p><p class="text-center ma-0" data-v-aa921a51${_scopeId3}>\xA9 ${ssrInterpolate(unref(footerText))}</p>`);
                      } else {
                        return [
                          createVNode("p", { class: "text-center ma-0" }, toDisplayString(personalMessage)),
                          createVNode("p", { class: "text-center ma-0" }, "\xA9 " + toDisplayString(unref(footerText)), 1)
                        ];
                      }
                    }),
                    _: 1
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-aa921a51"]]);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_toolbar_title, { class: "ml-0" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h2 class="logo text-subtitle-1 text-sm-h6 text-md-h5 text-wrap"${_scopeId3}>`);
                        ...
                        return [
                          createVNode("h2", { class: "logo text-subtitle-1 text-sm-h6 text-md-h5 text-wrap" }, [
...
//# sourceMappingURL=default-3a4f5663.mjs.map
