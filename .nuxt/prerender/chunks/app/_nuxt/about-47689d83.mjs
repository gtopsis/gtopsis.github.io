import { useSSRContext, defineComponent, computed, resolveComponent, mergeProps, withCtx, unref, createVNode, toDisplayString, toHandlers, createTextVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/vue/index.mjs';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 data-v-6976eb98${_scopeId3}>${ssrInterpolate(unref(timelineTitle))}</h1>`);
                      } else {
                        return [
                                    ...
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_component_v_tooltip, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<span data-v-6976eb98${_scopeId6}>${ssrInterpolate(item.avatar.label.text)}</span>`);
                                          } else {
                                            return [
                                          ...
                                          if (_push7) {
                                            _push7(ssrRenderComponent(_component_v_card_title, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<h4 class="timeline-item-title text-left text-subtitle text-md-body-1 text-bold text-wrap font-weight-bold" data-v-6976eb98${_scopeId7}>${ssrInterpolate(item.card.title)}</h4>`);
                                                } else {
                                                  return [
                                            ...
                                            _push7(ssrRenderComponent(_component_v_card_text, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<p class="mb-0" data-v-6976eb98${_scopeId7}>`);
                                                  if (item.avatar.label.link) {
                                                    _push8(`<a class="text-secondary"${ssrRenderAttr("href", item.avatar.label.link)} target="_blank" rel="noopener noreferrer" data-v-6976eb98${_scopeId7}>${ssrInterpolate(item.avatar.label.text)}</a>`);
                                                  } else {
                                                    _push8(`<span data-v-6976eb98${_scopeId7}>${ssrInterpolate(item.avatar.label.text)}</span>`);
                                                  }
                                                  _push8(`</p><p class="ma-0" data-v-6976eb98${_scopeId7}>${ssrInterpolate(item.card.description)}</p><ul class="ma-2" data-v-6976eb98${_scopeId7}><!--[-->`);
                                                  ssrRenderList(item.card.tools, (tool, j) => {
                                                    _push8(`<li class="text-left" data-v-6976eb98${_scopeId7}><span data-v-6976eb98${_scopeId7}>${ssrInterpolate(tool)}</span></li>`);
                                                  });
                                                  _push8(`<!--]--></ul>`);
                                                } else {
                                                  return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6976eb98"]]);
...
//# sourceMappingURL=about-47689d83.mjs.map
