...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-a94c147b"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function navigateToSocialNetwork(url) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                              ...
                              ssrRenderList(socials, (social, index) => {
                                _push5(ssrRenderComponent(_component_v_col, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<button${ssrRenderAttr("aria-label", social.text)} data-v-7fd966a4${_scopeId5}><span class="visually-hidden" data-v-7fd966a4${_scopeId5}>${ssrInterpolate(social.text)}</span>`);
                                      ...
                                      return [
                                        createVNode("button", {
                                          ...
                                          onClick: ($event) => navigateToSocialNetwork(social.link)
                                        }, [
                  ...
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p class="text-center ma-0" data-v-7fd966a4${_scopeId3}>${ssrInterpolate(personalMessage)}</p><p class="text-center ma-0" data-v-7fd966a4${_scopeId3}>\xA9 ${ssrInterpolate(footerText)}</p>`);
                      } else {
                        return [
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7fd966a4"]]);
...
//# sourceMappingURL=default-77273bc0.mjs.map
