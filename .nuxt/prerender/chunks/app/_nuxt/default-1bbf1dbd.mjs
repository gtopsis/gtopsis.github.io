...
import { resolveComponent, withCtx, createTextVNode, toDisplayString, createVNode, renderSlot, useSSRContext, computed, mergeProps, unref, toHandlers, openBlock, createBlock, Fragment, renderList } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderAttrs, ssrRenderList, ssrRenderAttr } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/vue/server-renderer/index.mjs';
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              _push3(ssrRenderComponent(_component_v_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<p class="text-center ma-0" data-v-3c638566${_scopeId3}>${ssrInterpolate($data.personalMessage)}</p><p class="text-center ma-0" data-v-3c638566${_scopeId3}>\xA9 ${ssrInterpolate($options.footerText)}</p>`);
                  } else {
                    return [
                      createVNode("p", { class: "text-center ma-0" }, toDisplayString($data.personalMessage), 1),
                      createVNode("p", { class: "text-center ma-0" }, "\xA9 " + toDisplayString($options.footerText), 1)
                    ];
                  }
                }),
                _: 1
...
//# sourceMappingURL=default-1bbf1dbd.mjs.map
