import { version as version$1, inject as inject$1, createVNode, mergeProps, toRefs, Transition, ref, computed, watch, nextTick, toRef, Text, watchEffect, provide, onScopeDispose, withDirectives, resolveDirective, vShow, Fragment as Fragment$1, reactive, capitalize, h, getCurrentInstance as getCurrentInstance$1, shallowRef, defineComponent as defineComponent$1, camelize, unref, isRef, toRaw, readonly, TransitionGroup, resolveDynamicComponent, cloneVNode, effectScope, warn, toHandlers, Teleport, createTextVNode, vModelText, useSSRContext, createApp, markRaw, isReactive, getCurrentScope, onErrorCaptured, onServerPrefetch, isReadonly, defineAsyncComponent, withCtx, Suspense } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/unctx/dist/index.mjs';
import { renderSSRHead } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/@unhead/ssr/dist/index.mjs';
import { getActiveHead, createServerHead as createServerHead$1 } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/unhead/dist/index.mjs';
import { HasElementTags, defineHeadPlugin } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/@unhead/shared/dist/index.mjs';
import { createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/vue-router/dist/vue-router.node.mjs';
import { sendRedirect, createError as createError$1 } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/h3/dist/index.mjs';
import { hasProtocol, parseURL, joinURL, isEqual } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderAttrs } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file:///home/gt0p/Personal%20Projects/gtopsis.github.io/node_modules/defu/dist/defu.mjs';
...
const appHead = { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "hid": "description", "name": "description", "content": "Everything about my work experience, education, personal projects and hobbies." }, { "name": "format-detection", "content": "telephone=no" }, { "hid": "twitter:card", "name": "twitter:card", "content": "summary_large_image" }, { "hid": "twitter:title", "name": "twitter:title", "content": "Giorgos Topsis - My personal website!" }, { "hid": "twitter:description", "name": "twitter:description", "content": "Everything about my work experience, education, personal projects and hobbies." }, { "hid": "twitter:image", "name": "twitter:image", "content": "./images/portfolio.png" }, { "hid": "og:site_name", "property": "og:site_name", "content": "Giorgos Topsis - My personal website!" }, { "hid": "og:type", "property": "og:type", "content": "website" }, { "hid": "og:url", "property": "og:url", "content": "https://nuxtjs.org" }, { "hid": "og:title", "property": "og:title", "content": "Giorgos Topsis - My personal website!" }, { "hid": "og:description", "property": "og:description", "content": "Everything about my work experience, education, personal projects and hobbies." }, { "hid": "og:image", "property": "og:image", "content": "./images/Twitter-card.png" }, { "hid": "og:image:secure_url", "property": "og:image:secure_url", "content": "./images/Twitter-card.png" }], "link": [{ "rel": "icon", "type": "image/x-icon", "href": "/favicon.ico" }], "style": [], "script": [], "noscript": [], "titleTemplate": "%s - Giorgos Topsis", "htmlAttrs": { "lang": "en" } };
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-1c37f8dd.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ea33c5a3.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-1bbf1dbd.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-c18e7e10.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useDisplay as a, useRouter$1 as b, createError as c, defineStore as d, entry$1 as default, useTheme as e, navigateTo as n, useHead as u };
