var _a;
import { reactive, getCurrentInstance as getCurrentInstance$1, effectScope, ref, markRaw, toRaw, watch, unref, inject as inject$1, isRef, isReactive, toRef, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, version as version$1, watchEffect, shallowRef, isReadonly, capitalize, defineComponent as defineComponent$1, camelize, h, provide, createVNode, mergeProps, readonly, TransitionGroup, Transition, withDirectives, Fragment as Fragment$1, resolveDirective, vShow, Text, resolveDynamicComponent, cloneVNode, warn, toHandlers, Teleport, createTextVNode, vModelText, Suspense, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, defineAsyncComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-1c37f8dd.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-ea33c5a3.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-1bbf1dbd.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-c18e7e10.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-43f34c46.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
