...
const ThemeToggle_vue_vue_type_style_index_0_scoped_fc0522a4_lang = "";
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p class="text-center ma-0" data-v-aa921a51${_scopeId3}>${ssrInterpolate(personalMessage)}</p><p class="text-center ma-0" data-v-aa921a51${_scopeId3}>© ${ssrInterpolate(unref(footerText))}</p>`);
                      } else {
                        return [
...
const MainFooter_vue_vue_type_style_index_0_scoped_aa921a51_lang = "";
...
//# sourceMappingURL=default-3a4f5663.js.map
