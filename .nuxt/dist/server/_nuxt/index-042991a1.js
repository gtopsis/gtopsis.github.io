import { _ as __nuxt_component_0$1 } from "./nuxt-link-691ee40a.js";
import { defineComponent, resolveComponent, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, useSSRContext, reactive, computed, unref, openBlock, createBlock, Fragment, renderList } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderList } from "vue/server-renderer";
import { _ as _export_sfc, d as defineStore, s as storeToRefs, b as __nuxt_component_0$2, u as useHead } from "../server.mjs";
import "hookable";
import "destr";
import "devalue";
import "klona";
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headline text-h5 text-md-h5 text-lg-h4" data-v-4e747455${_scopeId3}><span data-v-4e747455${_scopeId3}>${ssrInterpolate(headline.pre)} `);
                        ...
                        _push4(` ${ssrInterpolate(headline.name.pronunciation)},<br data-v-4e747455${_scopeId3}> ${ssrInterpolate(headline.post)}</span></h1>`);
                      } else {
                        return [
...
const HeroSection_vue_vue_type_style_index_0_scoped_4e747455_lang = "";
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4e747455"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_nuxt_picture = __nuxt_component_0$2;
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 data-v-7247a874${_scopeId3}>${ssrInterpolate(title)}</h1>`);
                      } else {
                        return [
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_v_card, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_nuxt_picture, {
                                ...
                                return [
                                  createVNode(_component_nuxt_picture, {
                                    "img-attrs": { class: "align-end text-white" },
                                    src: meetup.src,
                                    alt: meetup.description,
                                    placeholder: "",
...
const MeetupsList_vue_vue_type_style_index_0_scoped_7247a874_lang = "";
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-7247a874"]]);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 data-v-f73f13a4${_scopeId3}>${ssrInterpolate(title)}</h1>`);
                      } else {
                        return [
                          createVNode("h1", null, toDisplayString(title))
                        ];
                              ...
                              if (_push5) {
                                ...
                                _push5(ssrRenderComponent(_component_v_card_text, null, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<p class="project-description" data-v-f73f13a4${_scopeId5}>${ssrInterpolate(project.description)}</p>`);
                                    } else {
                                      return [
...
const ProjectsList_vue_vue_type_style_index_0_scoped_f73f13a4_lang = "";
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-f73f13a4"]]);
    ...
    useHead({
      ...
      meta: [
        // hid is used as unique identifier. Do not use `vmid` for it as it will not work
        {
          hid: "description",
          name: "description",
          content: "Home page of my personal website. It contains details about my participation on activities and several personal projects and ."
        }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
...
const index_vue_vue_type_style_index_0_scoped_c8a47ab1_lang = "";
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c8a47ab1"]]);
export {
  index as default
};
//# sourceMappingURL=index-042991a1.js.map
