...
import { _ as _export_sfc, d as defineStore, s as storeToRefs, u as useHead } from "../server.mjs";
import "hookable";
import "destr";
import "devalue";
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 class="headline text-h6 text-md-h5 text-lg-h4" data-v-bf6ab422${_scopeId3}><span data-v-bf6ab422${_scopeId3}>${ssrInterpolate(headline.pre)} `);
                        ...
                        _push4(` ${ssrInterpolate(headline.name.pronunciation)},<br data-v-bf6ab422${_scopeId3}> ${ssrInterpolate(headline.post)}</span></h1>`);
                      } else {
                        return [
...
const HeroSection_vue_vue_type_style_index_0_scoped_bf6ab422_lang = "";
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-bf6ab422"]]);
const useProjectsStore = defineStore("ProjectsStore", () => {
  const projects = reactive([
    ...
    },
    {
      ...
      description: "A responsive and usable website for the FM radio station of university of Crete.",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 data-v-de5c0d9d${_scopeId3}>${ssrInterpolate(title)}</h1>`);
                      } else {
                        return [
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(ssrRenderComponent(_component_v_card_text, null, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<p class="project-description" data-v-de5c0d9d${_scopeId5}>${ssrInterpolate(project.description)}</p>`);
                                    } else {
                                      return [
...
const ProjectsList_vue_vue_type_style_index_0_scoped_de5c0d9d_lang = "";
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-de5c0d9d"]]);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 data-v-624f2ee8${_scopeId3}>${ssrInterpolate(title)}</h1>`);
                      } else {
                        return [
                          createVNode("h1", null, toDisplayString(title))
                        ];
...
const MeetupsList_vue_vue_type_style_index_0_scoped_624f2ee8_lang = "";
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-624f2ee8"]]);
...
const index_vue_vue_type_style_index_0_scoped_8d177b7d_lang = "";
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8d177b7d"]]);
export {
  index as default
};
//# sourceMappingURL=index-1f8e419a.js.map
