                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 data-v-e2a52b5e${_scopeId3}>${ssrInterpolate(unref(timelineTitle))}</h1>`);
                      } else {
                        return [
                                    ...
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_component_v_tooltip, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<span id="timelineItemTooltipText" data-v-e2a52b5e${_scopeId6}>${ssrInterpolate(item.avatar.label.text)}</span>`);
                                          } else {
                                            return [
                                          ...
                                          if (_push7) {
                                            _push7(ssrRenderComponent(_component_v_card_title, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<span class="timeline-item-title text-left text-subtitle text-md-body-1 text-bold text-wrap font-weight-bold" data-v-e2a52b5e${_scopeId7}>${ssrInterpolate(item.title)}</span>`);
                                                } else {
                                                  return [
                                            ...
                                            _push7(ssrRenderComponent(_component_v_card_subtitle, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<span data-v-e2a52b5e${_scopeId7}>${ssrInterpolate(item.period.start)} - ${ssrInterpolate(item.period.end)}</span><p class="mb-0" data-v-e2a52b5e${_scopeId7}>`);
                                                  if (item.avatar.label.link) {
                                                    _push8(`<a class="text-secondary font-weight-bold"${ssrRenderAttr("href", item.avatar.label.link)} target="_blank" rel="noopener noreferrer" data-v-e2a52b5e${_scopeId7}>${ssrInterpolate(item.avatar.label.text)}</a>`);
                                                  } else {
                                                    _push8(`<span class="text-secondary font-weight-bold" data-v-e2a52b5e${_scopeId7}>${ssrInterpolate(item.avatar.label.text)}</span>`);
                                                  }
                                                  _push8(`</p>`);
                                                } else {
                                                  return [
                                            ...
                                            _push7(ssrRenderComponent(_component_v_card_text, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<p class="ma-0" data-v-e2a52b5e${_scopeId7}>${ssrInterpolate(item.description)}</p><ul class="ma-2" data-v-e2a52b5e${_scopeId7}><!--[-->`);
                                                  ssrRenderList(item.tools, (tool, j) => {
                                                    _push8(`<li class="text-left" data-v-e2a52b5e${_scopeId7}><span data-v-e2a52b5e${_scopeId7}>${ssrInterpolate(tool)}</span></li>`);
                                                  });
                                                  _push8(`<!--]--></ul>`);
                                                } else {
                                                  return [
...
const TimelineSection_vue_vue_type_style_index_0_scoped_e2a52b5e_lang = "";
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e2a52b5e"]]);
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_v_col, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<p class="text-center text-h5 text-sm-h5 text-md-h4" data-v-c58a5010${_scopeId6}> What You <span class="text-primary" data-v-c58a5010${_scopeId6}>Read</span> is What you Get </p>`);
                                        } else {
                                          return [
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          ssrRenderList(unref(aboutMe), (paragraph, i) => {
                                            _push7(`<p class="text-left text-body-1 mb-6" white data-v-c58a5010${_scopeId6}>${ssrInterpolate(paragraph)}</p>`);
                                          });
                                          _push7(`<!--]-->`);
                                        } else {
                                          return [
...
const AboutPage_vue_vue_type_style_index_0_scoped_c58a5010_lang = "";
...
const AboutPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c58a5010"]]);
export {
  AboutPage as default
};
//# sourceMappingURL=AboutPage-b5213222.js.map
