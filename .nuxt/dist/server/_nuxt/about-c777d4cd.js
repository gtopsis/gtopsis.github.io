                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 data-v-7beaac0c${_scopeId3}>${ssrInterpolate(unref(timelineTitle))}</h1>`);
                      } else {
                        return [
                                    ...
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_component_v_tooltip, { location: "bottom" }, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<span data-v-7beaac0c${_scopeId6}>${ssrInterpolate(item.avatar.label.text)}</span>`);
                                          } else {
                                            return [
                                          ...
                                          if (_push7) {
                                            _push7(ssrRenderComponent(_component_v_card_title, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<h4 class="timeline-item-title text-left text-subtitle text-md-body-1 text-bold text-wrap font-weight-bold" data-v-7beaac0c${_scopeId7}>${ssrInterpolate(item.title)}</h4>`);
                                                } else {
                                                  return [
                                                    createVNode("h4", { class: "timeline-item-title text-left text-subtitle text-md-body-1 text-bold text-wrap font-weight-bold" }, toDisplayString(item.title), 1)
                                                  ];
                                                }
                                              }),
                                              _: 2
                                            ...
                                            _push7(ssrRenderComponent(_component_v_card_subtitle, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<span data-v-7beaac0c${_scopeId7}>${ssrInterpolate(item.period.start)} - ${ssrInterpolate(item.period.end)}</span><p class="mb-0" data-v-7beaac0c${_scopeId7}>`);
                                                  if (item.avatar.label.link) {
                                                    _push8(`<a class="text-secondary font-weight-bold"${ssrRenderAttr("href", item.avatar.label.link)} target="_blank" rel="noopener noreferrer" data-v-7beaac0c${_scopeId7}>${ssrInterpolate(item.avatar.label.text)}</a>`);
                                                  } else {
                                                    _push8(`<span class="text-secondary font-weight-bold" data-v-7beaac0c${_scopeId7}>${ssrInterpolate(item.avatar.label.text)}</span>`);
                                                  }
                                                  _push8(`</p>`);
                                                } else {
                                                  return [
                                            ...
                                            _push7(ssrRenderComponent(_component_v_card_text, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<p class="ma-0" data-v-7beaac0c${_scopeId7}>${ssrInterpolate(item.description)}</p><ul class="ma-2" data-v-7beaac0c${_scopeId7}><!--[-->`);
                                                  ssrRenderList(item.tools, (tool, j) => {
                                                    _push8(`<li class="text-left" data-v-7beaac0c${_scopeId7}><span data-v-7beaac0c${_scopeId7}>${ssrInterpolate(tool)}</span></li>`);
                                                  });
                                                  _push8(`<!--]--></ul>`);
                                                } else {
                                                  return [
...
const Timeline_vue_vue_type_style_index_0_scoped_7beaac0c_lang = "";
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-7beaac0c"]]);
...
//# sourceMappingURL=about-c777d4cd.js.map
