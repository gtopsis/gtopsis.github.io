...
import { defineComponent, useSSRContext, computed, resolveComponent, mergeProps, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createTextVNode, createCommentVNode } from "vue";
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 data-v-63fa1527${_scopeId3}>${ssrInterpolate(unref(timelineTitle))}</h1>`);
                      } else {
                        return [
                              ...
                              ssrRenderList(unref(timelineItems), (item, i) => {
                                _push5(ssrRenderComponent(_component_v_timeline_item, {
                                  ...
                                  icon: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_component_v_tooltip, { location: "bottom" }, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<span data-v-63fa1527${_scopeId6}>${ssrInterpolate(item.avatar.label.text)}</span>`);
                                          } else {
                                            return [
                                          ...
                                          if (_push7) {
                                            _push7(ssrRenderComponent(_component_v_card_title, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<h4 class="timeline-item-title text-left text-subtitle text-md-body-1 text-bold text-wrap font-weight-bold" data-v-63fa1527${_scopeId7}>${ssrInterpolate(item.card.title)}</h4>`);
                                                } else {
                                                  return [
                                            ...
                                            _push7(ssrRenderComponent(_component_v_card_subtitle, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<span data-v-63fa1527${_scopeId7}>${ssrInterpolate(item.card.period.start)} - ${ssrInterpolate(item.card.period.end)}</span><p class="mb-0" data-v-63fa1527${_scopeId7}>`);
                                                  if (item.avatar.label.link) {
                                                    _push8(`<a class="text-secondary font-weight-bold"${ssrRenderAttr("href", item.avatar.label.link)} target="_blank" rel="noopener noreferrer" data-v-63fa1527${_scopeId7}>${ssrInterpolate(item.avatar.label.text)}</a>`);
                                                  } else {
                                                    _push8(`<span class="text-secondary font-weight-bold" data-v-63fa1527${_scopeId7}>${ssrInterpolate(item.avatar.label.text)}</span>`);
                                                  }
                                                  _push8(`</p>`);
                                                } else {
                                                  return [
                                            ...
                                            _push7(ssrRenderComponent(_component_v_card_text, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<p class="ma-0" data-v-63fa1527${_scopeId7}>${ssrInterpolate(item.card.description)}</p><ul class="ma-2" data-v-63fa1527${_scopeId7}><!--[-->`);
                                                  ssrRenderList(item.card.tools, (tool, j) => {
                                                    _push8(`<li class="text-left" data-v-63fa1527${_scopeId7}><span data-v-63fa1527${_scopeId7}>${ssrInterpolate(tool)}</span></li>`);
                                                  });
                                                  _push8(`<!--]--></ul>`);
                                                } else {
                                                  return [
...
const Timeline_vue_vue_type_style_index_0_scoped_63fa1527_lang = "";
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-63fa1527"]]);
...
//# sourceMappingURL=about-52626862.js.map
