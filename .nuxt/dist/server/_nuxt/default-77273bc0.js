...
const ThemeToggle_vue_vue_type_style_index_0_scoped_a94c147b_lang = "";
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p class="text-center ma-0" data-v-7fd966a4${_scopeId3}>${ssrInterpolate(personalMessage)}</p><p class="text-center ma-0" data-v-7fd966a4${_scopeId3}>© ${ssrInterpolate(footerText)}</p>`);
                      } else {
                        return [
                          createVNode("p", { class: "text-center ma-0" }, toDisplayString(personalMessage)),
                          createVNode("p", { class: "text-center ma-0" }, "© " + toDisplayString(footerText))
                        ];
                      }
                    }),
                    _: 1
...
const MainFooter_vue_vue_type_style_index_0_scoped_7fd966a4_lang = "";
...
//# sourceMappingURL=default-77273bc0.js.map
