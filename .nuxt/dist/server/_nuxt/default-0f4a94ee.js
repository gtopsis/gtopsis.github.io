...
import { defineComponent, resolveComponent, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, useSSRContext, computed, unref, createTextVNode, renderSlot } from "vue";
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p class="text-center ma-0" data-v-5435578a${_scopeId3}>${ssrInterpolate(personalMessage)}</p><p class="text-center ma-0" data-v-5435578a${_scopeId3}>© ${ssrInterpolate(footerText)}</p>`);
                      } else {
                        return [
...
const MainFooter_vue_vue_type_style_index_0_scoped_5435578a_lang = "";
                  ...
                  _push3(ssrRenderComponent(_component_v_tooltip, {
                    ...
                    activator: withCtx(({ props }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        }, props, { onClick: toggleDarkMode }), null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(_component_font_awesome_icon, mergeProps({
                            class: "toggle",
                            icon: ["fas", unref(disabledTheme) === "light" ? "sun" : "moon"]
                          }, props, { onClick: toggleDarkMode }), null, 16, ["icon"])
                        ];
                      }
                    }),
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span id="themeTogglePromptText" data-v-f8bdbf83${_scopeId3}>Enable ${ssrInterpolate(unref(disabledTheme))} mode</span>`);
                      } else {
                        return [
...
const ThemeToggle_vue_vue_type_style_index_0_scoped_f8bdbf83_lang = "";
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-f8bdbf83"]]);
...
//# sourceMappingURL=default-0f4a94ee.js.map
