...
import { defineComponent, useSSRContext, reactive, computed, resolveComponent, mergeProps, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createTextVNode, createCommentVNode } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
import { u as useHead, d as defineStore, a as useDisplay, s as storeToRefs, _ as _export_sfc } from "../server.mjs";
import "hookable";
import "destr";
import "devalue";
import "unhead";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_row, {
              align: "center",
              class: "justify-md-center justify-sm-left mb-8"
            }, {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 data-v-e8af9700${_scopeId3}>${ssrInterpolate(unref(timelineTitle))}</h1>`);
                      } else {
                        return [
                                    ...
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_component_v_tooltip, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<span id="timelineItemTooltipText" data-v-e8af9700${_scopeId6}>${ssrInterpolate(item.avatar.label.text)}</span>`);
                                          } else {
                                            return [
                                          ...
                                          if (_push7) {
                                            _push7(ssrRenderComponent(_component_v_card_title, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<span class="timeline-item-title text-left text-subtitle text-md-body-1 text-bold text-wrap font-weight-bold" data-v-e8af9700${_scopeId7}>${ssrInterpolate(item.title)}</span>`);
                                                } else {
                                                  return [
                                            ...
                                            _push7(ssrRenderComponent(_component_v_card_subtitle, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<span data-v-e8af9700${_scopeId7}>${ssrInterpolate(item.period.start)} - ${ssrInterpolate(item.period.end)}</span><p class="mb-0" data-v-e8af9700${_scopeId7}>`);
                                                  if (item.avatar.label.link) {
                                                    _push8(`<a class="text-secondary font-weight-bold"${ssrRenderAttr("href", item.avatar.label.link)} target="_blank" rel="noopener noreferrer" data-v-e8af9700${_scopeId7}>${ssrInterpolate(item.avatar.label.text)}</a>`);
                                                  } else {
                                                    _push8(`<span class="text-secondary font-weight-bold" data-v-e8af9700${_scopeId7}>${ssrInterpolate(item.avatar.label.text)}</span>`);
                                                  }
                                                  _push8(`</p>`);
                                                } else {
                                                  return [
                                            ...
                                            _push7(ssrRenderComponent(_component_v_card_text, null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<p class="ma-0" data-v-e8af9700${_scopeId7}>${ssrInterpolate(item.description)}</p><ul class="ma-2" data-v-e8af9700${_scopeId7}><!--[-->`);
                                                  ssrRenderList(item.tools, (tool, j) => {
                                                    _push8(`<li class="text-left" data-v-e8af9700${_scopeId7}><span data-v-e8af9700${_scopeId7}>${ssrInterpolate(tool)}</span></li>`);
                                                  });
                                                  _push8(`<!--]--></ul>`);
                                                } else {
                                                  return [
...
const TimelineSection_vue_vue_type_style_index_0_scoped_e8af9700_lang = "";
...
const useAboutMeStore = defineStore("AboutMeStore", () => {
  ...
  const personal1 = "As a partner, I seek trustworthy connections, and I enjoy being in work environments where meritocracy prevails. In such conditions, I feel like a productive and funny teammate ツ.";
  const personal2 = "When I'm away from the keyboard, I like joining local meetups (DevStaff, Open Coffee Heraklion) as well as dance communities, learning and dancing mostly Argentinian Tango and Lindy Hop.";
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_v_col, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<p class="text-center text-h5 text-sm-h5 text-md-h4" data-v-967ccf98${_scopeId6}> What You <span class="text-primary" data-v-967ccf98${_scopeId6}>Read</span> is What you Get </p>`);
                                        } else {
                                          return [
                                            createVNode("p", { class: "text-center text-h5 text-sm-h5 text-md-h4" }, [
                                  ...
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_v_col, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<!--[-->`);
                                          ssrRenderList(unref(aboutMe), (paragraph, i) => {
                                            _push7(`<p class="text-left text-body-1 mb-6" white data-v-967ccf98${_scopeId6}>${ssrInterpolate(paragraph)}</p>`);
                                          });
                                          _push7(`<!--]-->`);
                                        } else {
                                          return [
                                            (openBlock(true), createBlock(Fragment, null, renderList(unref(aboutMe), (paragraph, i) => {
                  ...
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_TimelineSection, { content: "experience" }, null, _parent4, _scopeId3));
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_v_col, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_TimelineSection, { content: "education" }, null, _parent4, _scopeId3));
                      } else {
                        return [
...
const AboutPage_vue_vue_type_style_index_0_scoped_967ccf98_lang = "";
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/AboutPage.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const AboutPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-967ccf98"]]);
export {
  AboutPage as default
};
//# sourceMappingURL=AboutPage-1cbdd9b1.js.map
