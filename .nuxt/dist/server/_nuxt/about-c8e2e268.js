                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_v_col, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<p class="text-center text-h5 text-sm-h5 text-md-h4" data-v-3d5e9ea0${_scopeId6}> What You <span class="text-primary" data-v-3d5e9ea0${_scopeId6}>Read</span> is What you Get </p>`);
                                        } else {
                                          return [
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          ssrRenderList(unref(aboutMe), (paragraph, i) => {
                                            _push7(`<p class="text-left text-body-1 mb-6" white data-v-3d5e9ea0${_scopeId6}>${ssrInterpolate(paragraph)}</p>`);
                                          });
                                          _push7(`<!--]-->`);
                                        } else {
                                          return [
...
const about_vue_vue_type_style_index_0_scoped_3d5e9ea0_lang = "";
...
const about = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3d5e9ea0"]]);
export {
  about as default
};
//# sourceMappingURL=about-c8e2e268.js.map
